...
<body class="menu-page">
	...
	<?php
            $menu_url = "https://ccpl.ninjaos.com/api/cms/page?status=A&app_id=".$app_id."&page_slug=contact-us";
            $menu_header = array();
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center font-weight-bold text-light">
                    <h1 class="display-4 m-0"><?php echo $menu_values['result_set'][0]['cmspage_title'];?></h1>
    ...
    <div class="container">
    	<?php echo $menu_values['result_set'][0]['cmspage_description'];?>
    </div>
